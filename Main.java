...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // call computePath in A_StarAlgorithm class and pass it both the start and end Vertex.
        A_StarAlgorithm a_star = new A_StarAlgorithm();

        a_star.computePath(start, end);

        // call getPath in A_StarAlgorithm class
        List<Vertex> path = a_star.getPath(end);
        
        System.out.printf("\nPath from %s to %s = %s\n", start, end, path);
        System.out.printf("\nDistance from %s to %s = %f miles\n", start, end, end.getDistance());
        System.out.printf("Path size = %d\n", path.size());
        System.out.printf("Poll count = %,d\n", A_StarAlgorithm.pollCount);
